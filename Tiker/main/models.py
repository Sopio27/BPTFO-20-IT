...
class Task(models.Model):
    ...
    # AssignedUserId = models.ForeignKey(User, related_name='assignee', on_delete=models.CASCADE) #აქ გადასაკეთებელი იქნება დამრეგისტრირებელი მოხმარებლის FK-ზე models.ForeignKey(Author, on_delete=models.SET_NULL, null=True)
